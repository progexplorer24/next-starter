...
<SubHeading>
  In this section you will explore an example of a popular type-scale.
</SubHeading>

---

For the example of a type scale I used Material Design type scale generator.
...
Checkout: [Roboto Type Scale](https://material.io/design/typography/the-type-system.html#type-scale)
...
- **Limit line length to 40-120 characters** - longer lines confuse reader. Generally text on screens should be shorter than text in books etc. When using longer lines increace line spacing.
